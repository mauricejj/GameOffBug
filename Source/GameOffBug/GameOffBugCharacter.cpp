...
void AGameOffBugCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("TurnRate", this, &AGameOffBugCharacter::TurnAtRate);
...
void AGameOffBugCharacter::MoveForward(float Value)
{
...
void AGameOffBugCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
